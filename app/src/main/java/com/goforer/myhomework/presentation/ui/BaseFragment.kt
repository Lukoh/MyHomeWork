...
abstract class BaseFragment<T : ViewBinding> : Fragment(), Injectable {
    ...
    companion object {
        ...
        const val FRAGMENT_RESULT_FROM_SIGN_UP = "resultKey_sign_up"
        const val FRAGMENT_RESULT_FROM_USER_INFO = "resultKey_user_info"
        const val FRAGMENT_RESULT_FROM_CARD_INFO = "resultKey_card_info"
    }
