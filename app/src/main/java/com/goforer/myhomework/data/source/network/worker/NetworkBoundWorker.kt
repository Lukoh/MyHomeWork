...
package com.goforer.myhomework.data.source.network.worker

import androidx.annotation.MainThread
import androidx.annotation.WorkerThread
import com.goforer.base.extension.isNullOnFlow
import com.goforer.myhomework.data.source.network.response.*
...
abstract class NetworkBoundWorker<Result, ResponseValue> constructor(
    ...
    companion object {
        internal const val NONE_ITEM_COUNT = 20
