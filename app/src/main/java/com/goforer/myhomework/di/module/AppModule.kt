...
package com.goforer.myhomework.di.module
...
import com.goforer.myhomework.BuildConfig
...
import com.goforer.myhomework.data.source.network.factory.FlowCallAdapterFactory
import com.goforer.myhomework.data.source.network.factory.NullOnEmptyConverterFactory
import com.goforer.myhomework.presentation.Caller
import com.goforer.myhomework.presentation.Caller.preparingService
...
class AppModule {
    ...
    @Singleton
    @Provides
    fun provideLocalStorage(context: Context): LocalStorage = LocalStorage(context)
